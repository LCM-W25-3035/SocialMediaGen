...
def save_to_mongodb(data, mongodb_url="mongodb+srv://funniket:Annu96545%40@cluster0.m20bs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", db_name="news_db", collection_name="yahoo_news"):
    """
...
def run_yahoo_news_scraper():
    """
    Run the Yahoo News scraper and save the results to MongoDB.
    """
